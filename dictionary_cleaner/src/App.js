...
function App() {
  ...
  const [duplicates, setDuplicates] = useState(null); // lift state here
    ...
    <div className="App" style={{ padding: '20px' }}>
      ...
      {editingConceptId && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)' }}>
          <div style={{ background: '#fff', margin: 'auto', padding: '20px', width: '400px', borderRadius: '8px' }}>
            <button onClick={closeEditModal} style={{ float: 'right', cursor: 'pointer' }}>X</button>
            <h3>Edit Concept</h3>
            <EditConceptForm
